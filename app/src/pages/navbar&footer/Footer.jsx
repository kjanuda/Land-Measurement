        ...
        <div className="footer__main">
          <div className="footer__grid">
            ...
            <div className="footer__brand">
              <Link href="/" className="footer__logo" aria-label="SVR — Home">
                <span className="footer__logo-mark">SVR</span>
                <span className="footer__logo-sub">Geospatial</span>
              </Link>
              <p className="footer__brand-desc">
                Delivering precision geospatial data and professional survey services
                to public agencies and infrastructure projects nationwide since 1954.
              </p>
              ...
              <div className="footer__contact-strip" style={{ marginTop: 24 }}>
                <div className="footer__contact-item">
                  ...
                  <span className="footer__contact-label">Washington, DC Metro</span>
                </div>
                <div className="footer__contact-item">
                  <div className="footer__contact-icon">
                    <svg width="12" height="12" viewBox="0 0 14 14" fill="none" aria-hidden="true">
                  ...
                  <a href="tel:+18005550100" className="footer__contact-label">+1 800 555 0100</a>
                </div>
                <div className="footer__contact-item">
                  <div className="footer__contact-icon">
                    <svg width="12" height="12" viewBox="0 0 14 14" fill="none" aria-hidden="true">
                  ...
                  <a href="mailto:info@svr-geo.com" className="footer__contact-label">info@svr-geo.com</a>
                </div>
              </div>
            </div>
        ...
        <div className="footer__bottom">
          <div className="footer__bottom-inner">
            <p className="footer__copy">
              © {new Date().getFullYear()} <span>SVR Geospatial &amp; Survey Solutions</span>. All rights reserved.
            </p>
